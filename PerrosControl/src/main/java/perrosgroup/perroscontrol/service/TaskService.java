package perrosgroup.perroscontrol.service;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import perrosgroup.perroscontrol.model.Task;
import perrosgroup.perroscontrol.repository.TaskRepository;
...
public class TaskService {
    ...
    public Task addTask(Task task) {
        try {
            ...
            e.printStackTrace();
            throw e; // Puedes lanzar la excepción o manejarla según tu caso.
        }
    }
